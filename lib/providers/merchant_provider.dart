...
class LeadProvider extends ChangeNotifier {
  ...
  void toggleProduct(String product) {
    ...
    final wasSelected = current.contains(product);
    Analytics.track(
      wasSelected ? 'lead_product_deselected' : 'lead_product_selected',
  ...
  Future<String?> submit() async {
    ...
    await Analytics.track('lead_submit_attempted', properties: {
      'products': _lead.products,
      'has_microfinance_amount': _lead.microfinanceAmount != null,
      'has_device_count': _lead.acceptanceDeviceCount != null,
      'has_avg_sales': _lead.avgMonthlySales != null,
      'has_business_address':
          _lead.businessAddress != null && _lead.businessAddress!.isNotEmpty,
      'has_activity_type': _lead.activityTypeId != null,
      'notes_length': _lead.notes.length,
    });
    ...
    try {
      ...
      _isSubmitting = false;
      notifyListeners();
      await Analytics.track('lead_submit_succeeded', properties: {
        'products': _lead.products,
        'product_count': _lead.products.length,
      });
      ...
      if (e.code == '23505') {
        ...
        failureReason = 'invalid_nid';
      } else {
        _error = '\u062d\u062f\u062b \u062e\u0637\u0623 \u0623\u062b\u0646\u0627\u0621 \u0627\u0644\u062a\u0633\u062c\u064a\u0644';
        failureReason = 'postgrest_other';
      }

      notifyListeners();
      await Analytics.track('lead_submit_failed', properties: {
